  ...
  switch (action.type) {
    ...
    case 'UPDATE_LOCATION':
      ...
      return _objectSpread2(_objectSpread2({}, state), {}, {
        ...
        leaveInterim: null,
        modeInterim: '',
        currentLocation: _objectSpread2(_objectSpread2({}, action.location), {}, {
        ...
        prevLocation: _objectSpread2(_objectSpread2({}, state.currentLocation), {}, {
          y: state.currentLocation && getY(state.currentLocation.key)
        }),
        views: [null].concat(_toConsumableArray(filterViews(state.views))),
        keep: state.keepInterim ? _objectSpread2(_objectSpread2({}, state.views[0]), {}, {
          y: state.currentLocation && getY(state.currentLocation.key)
        }) : state.keep,
        keepInterim: false,
        hasEntered: false
...
var TransitionProvider = function TransitionProvider(props) {
  ...
  return /*#__PURE__*/React__default.createElement(TransitionContext.Provider, {
...
var TransitionView = function TransitionView(_ref) {
  ...
  React.useEffect(function () {
    switch (action) {
      case 'enter':
        set(_objectSpread2(_objectSpread2({}, usual), {}, {
          config: enter.config,
      ...
      case 'leave':
        ...
        set(_objectSpread2(_objectSpread2({}, leave), {}, {
          config: leave.config,
          onStart: function onStart(props) {
...
var TransitionViews = function TransitionViews(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    if (!view) return null;
    var isKeep = keep && keep.props.location.pathname === view.props.location.pathname;
    return /*#__PURE__*/React__default.createElement(TransitionView, {
  ...
  }), keep && /*#__PURE__*/React__default.createElement(TransitionKeep, {
